...
*Main dashboard view showcasing CPU/GPU priority cards with embedded Sparklines and thermal sensor grids.*

![Fan Curve Editor](doc/curve.png)
*Interactive SVG vector editor mapping instant cooling limits against 5 core response presets.*
